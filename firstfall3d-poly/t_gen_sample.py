...
## see table
vpp = pre.see_table(CorpsCandidat='RBDY3', candidat='POLYR',colorCandidat='BLUEx',behav=ppi,
                    CorpsAntagoniste='RBDY3', antagoniste='POLYR',colorAntagoniste='BLUEx',
                      alert=0.1)
vpw = pre.see_table(CorpsCandidat='RBDY3', candidat='POLYR',colorCandidat='BLUEx',behav=pwi,
